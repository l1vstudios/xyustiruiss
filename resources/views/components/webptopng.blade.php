...
<body>
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="box-title">WEBP TO PNG CONVERTER</h4>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('convert.webp-to-png') }}" class="dropzone" id="webp-upload" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="dz-message">
                                    <span>Drag and drop your WEBP file here or click to select a file</span>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        Dropzone.options.webpUpload = {
            paramName: "file",
            maxFilesize: 10,
            acceptedFiles: ".webp",
            dictDefaultMessage: "Drag and drop your WEBP file here or click to select a file",
