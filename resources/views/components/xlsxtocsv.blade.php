...
<body>
        ...
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="box-title">XLSX TO CSV CONVERTER</h4>
                        </div>

                        <div class="card-body">
                            <!-- Dropzone form for uploading XLSX file -->
                            <form action="{{ route('convert.xlsx-to-csv') }}" class="dropzone" id="cv-upload" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="dz-message">
                                    <span>Drag and drop your XLSX file here or click to select a file</span>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        Dropzone.options.cvUpload = {
            ...
            acceptedFiles: ".xlsx", // Only allow XLSX files
            dictDefaultMessage: "Drag and drop your XLSX file here or click to select a file",
            dictFallbackMessage: "Your browser does not support drag and drop file uploads.",
            dictInvalidFileType: "Only XLSX files are allowed.",
            ...
            success: function(file, response) {
                // On successful conversion, download the CSV file
                if (response.url) {
                    const link = document.createElement('a');
                    link.href = response.url;  // URL of the converted CSV
